...
# Loading data
df = pd.read_csv('/Users/neelsharma/Downloads/2024-11-16.csv', sep=',')

# Converting event_date to datetime and create basic features
...
# Creating KDTree for efficient spatial queries
...
# Encoding categorical variables (only those needed for the model)
...
# Adding markers with cached safe directions
