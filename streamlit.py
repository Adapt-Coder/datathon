...
# Sidebar form to submit warnings
...
def load_and_process_data():
    ...
    # Adding default values for missing columns
...
def train_random_forest(data):
    ...
    # Preprocess for numerical and categorical data
    ...
    # Train-test split and training our model
